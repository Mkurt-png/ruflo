  ...
  fr: {
    ...
    bullets: [
      ...
      },
      {
        ...
        body: 'Vos données bancaires ne transitent jamais par nkNOWTrade. Stripe est certifié PCI-DSS niveau 1.',
      },
      {
        icon: 'lock',
  ...
  en: {
    ...
    bullets: [
      ...
      },
      {
        ...
        body: 'Your card details never touch nkNOWTrade. Stripe is PCI-DSS Level 1 certified.',
      },
      {
        icon: 'lock',
