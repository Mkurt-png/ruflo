...
const copy = {
  fr: {
    ...
    description:
      'nkNOWTrade peut vous envoyer une notification douce une fois par jour, sans serveur — directement depuis votre navigateur, tant que cet onglet reste ouvert.',
    ...
    fired: '10 minutes ?',
    firedBody: 'Lancez votre leçon nkNOWTrade du jour.',
  },
  en: {
    title: 'Daily reminder',
    enabled: 'On. We will ping you tomorrow at the same time.',
    description:
      'nkNOWTrade can send you a gentle notification once a day, with no server — straight from your browser, as long as this tab stays open.',
    ...
    fired: '10 minutes?',
    firedBody: 'Run your nkNOWTrade lesson for today.',
  },
};
