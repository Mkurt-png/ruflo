...
const copy = {
  fr: {
    eyebrow: 'Diplôme nkNOWTrade',
    decoree: 'Décerné à',
    anonymous: '— anonyme —',
    body: 'Pour avoir suivi le cursus nkNOWTrade, complété les exercices et les points de contrôle des quinze pistes.',
    issued: 'Délivré le',
  ...
  en: {
    eyebrow: 'nkNOWTrade diploma',
    decoree: 'Awarded to',
    anonymous: '— anonymous —',
    body: 'For completing the nkNOWTrade curriculum, all drills and checkpoints across fifteen tracks.',
    issued: 'Issued',
