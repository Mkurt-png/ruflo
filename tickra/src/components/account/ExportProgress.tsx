...
export function ExportProgress({ locale }: { locale: Locale }) {
  ...
  return (
    <article aria-labelledby="export-progress-title" className="rounded-sm border border-line bg-surface p-7 md:p-9">
      <h2 id="export-progress-title" className="font-mono text-[11px] uppercase tracking-[0.22em] text-muted">{t.title}</h2>
