...
const copy = {
  fr: {
    ...
    subtitle: 'Un mini‑diplôme par piste validée. Le diplôme nkNOWTrade final à la 222.',
    counter: 'obtenus',
    earnedAt: 'Obtenu le',
    resume: 'Reprendre',
  ...
  en: {
    ...
    subtitle: 'One mini‑diploma per completed track. The final nkNOWTrade diploma at 222.',
    counter: 'earned',
    earnedAt: 'Earned on',
    resume: 'Resume',
