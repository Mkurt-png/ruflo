...
export function TrackCertificates({ locale }: { locale: Locale }) {
  ...
  return (
    <article aria-labelledby="track-certificates-title" className="rounded-sm border border-line bg-surface p-7 md:p-9">
      <div className="flex items-baseline justify-between">
        <h2 id="track-certificates-title" className="font-mono text-[11px] uppercase tracking-[0.22em] text-muted">{t.title}</h2>
