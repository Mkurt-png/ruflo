  ...
  fr: [
    {
      ...
      body: 'Cette page rassemble votre progression, vos favoris, vos certificats et les outils nkNOWTrade. Trois choses à savoir.',
      next: 'Suivant',
    },
    {
  ...
  en: [
    {
      ...
      body: 'This page collects your progress, bookmarks, certificates and nkNOWTrade tools. Three things to know.',
      next: 'Next',
    },
    {
