    ...
    <section id="method" aria-labelledby="method-title" className="bg-surface-warm py-24">
      <div className="mx-auto w-full max-w-container px-6 md:px-10">
        <div id="method-title">
          ...
          <h2 className="text-ink text-4xl font-medium mt-2 mb-16">{t.title}</h2>
        </div>
        ...
        <ol className="relative grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <span
            aria-hidden
            className="hidden md:block absolute top-7 left-[16.66%] right-[16.66%] h-px bg-elevated/20"
          />
            ...
            return (
              <li key={step.index} className="relative flex flex-col items-center text-center">
                <div className="relative">
                  <div className="w-14 h-14 rounded-full bg-elevated text-ink flex items-center justify-center text-lg font-medium mx-auto relative z-10">
                    <Icon aria-hidden className="h-6 w-6" strokeWidth={1.75} />
                  </div>
                  <span
                    aria-hidden
                    className="absolute -top-1 -right-3 text-[11px] font-mono text-muted"
                  >
                    {step.index}
                  </span>
                </div>
