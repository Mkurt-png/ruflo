...
const copy = {
  fr: {
    eyebrow: 'Leçon réservée à nkNOWTrade Pro',
    title: 'Pour aller plus loin, passez à Pro.',
    body: `Les ${FREE_LESSON_LIMIT} premières leçons sont gratuites pour vous donner la méthode. La suite — le détail, les exercices, le suivi de progression — fait partie de nkNOWTrade Pro.`,
    bullets: [
  ...
  en: {
    eyebrow: 'Lesson reserved for nkNOWTrade Pro',
    title: 'To go further, upgrade to Pro.',
    body: `The first ${FREE_LESSON_LIMIT} lessons are free so you see the method. The rest — the depth, the drills, the progression tracking — is part of nkNOWTrade Pro.`,
    bullets: [
