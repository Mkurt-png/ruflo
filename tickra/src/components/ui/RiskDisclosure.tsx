...
const COPY = {
  fr: {
    ...
    short:
      'Le trading comporte un risque élevé de perte rapide en capital. Les performances passées ne préjugent pas des performances futures. nkNOWTrade ne fournit ni signaux, ni conseil personnalisé en investissement.',
    long: [
      ...
      'nkNOWTrade est une plateforme d’éducation. Nous ne fournissons aucun signal d’achat ou de vente, aucun conseil personnalisé en investissement, ni aucune gestion de portefeuille. Nous ne sommes inscrits ni comme courtier ni comme conseiller auprès de l’Autorité des marchés financiers du Québec.',
  ...
  en: {
    label: 'Risk warning',
    short:
      'Trading carries a high risk of rapid capital loss. Past performance is not indicative of future results. nkNOWTrade provides no signals and no personalised investment advice.',
    long: [
      ...
      'nkNOWTrade is an education platform. We do not provide buy or sell signals, personalised investment advice, or portfolio management. We are registered neither as a dealer nor as an adviser with the Autorité des marchés financiers of Québec.',
