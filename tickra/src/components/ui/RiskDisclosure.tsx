...
const COPY = {
  fr: {
    ...
    short:
      'Le trading comporte un risque élevé de perte rapide en capital. Les performances passées ne préjugent pas des performances futures. Tickra ne fournit ni signaux, ni conseil personnalisé en investissement.',
    long: [
      ...
      'Tickra est une plateforme d’éducation. Nous ne fournissons aucun signal d’achat ou de vente, aucun conseil personnalisé en investissement, ni aucune gestion de portefeuille. Nous ne sommes pas un Prestataire de Services d’Investissement au sens du Code monétaire et financier.',
  ...
  en: {
    label: 'Risk warning',
    short:
      'Trading carries a high risk of rapid capital loss. Past performance is not indicative of future results. Tickra provides no signals and no personalised investment advice.',
    long: [
      ...
      'Tickra is an education platform. We do not provide buy or sell signals, personalised investment advice, or portfolio management. We are not an authorised Investment Services Provider.',
