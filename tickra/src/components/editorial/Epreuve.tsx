...
export function Epreuve({ locale }: Props) {
  ...
  return (
    <section
      ...
      className="relative bg-black text-white border-t border-white/[0.06] overflow-hidden"
    >
      <div className="ed-section">
        ...
        <div className="mt-20 md:mt-32 px-8 md:px-16">
          <p
            className="ed-display text-white"
        ...
        <div className="mt-24 md:mt-40 px-8 md:px-16 grid grid-cols-12 gap-x-6 items-baseline">
          <p className="col-span-12 md:col-span-7 lg:col-span-6 text-white/55 text-[15px] leading-relaxed">
            {locale === 'fr'
          ...
          <Link
            ...
            className="col-span-12 md:col-span-5 lg:col-span-6 md:text-right mt-8 md:mt-0 ed-tag text-white/85 hover:text-white transition-colors"
          >
