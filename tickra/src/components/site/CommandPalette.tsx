...
const staticPages = {
  fr: [
    ...
    { id: 'tools', label: 'Outils', href: '/tools', group: 'page' as const },
    ...
    { id: 'voix',            label: 'Les Voix',                 href: '/voix',             group: 'page' as const, hint: 'Entretiens mensuels' },
    { id: 'lexique',         label: 'Le Lexique vivant',        href: '/lexique',          group: 'page' as const, hint: 'Termes au clic' },
    { id: 'cercle',          label: 'Le Cercle de relecture',   href: '/cercle',           group: 'page' as const, hint: 'Pair de lecture' },
    { id: 'almanach',        label: 'L’Almanach',               href: '/almanach',         group: 'page' as const, hint: 'Archives des Criées' },
    { id: 'annuaire',        label: 'L’Annuaire',               href: '/annuaire',         group: 'page' as const, hint: 'Index des leçons' },
    { id: 'recherche',       label: 'La Recherche',             href: '/recherche',        group: 'page' as const, hint: 'Boîte vide' },
    { id: 'refus',           label: 'Le Refus',                 href: '/refus',            group: 'page' as const, hint: 'Manifeste par négation' },
    { id: 'erratum',         label: 'L’Erratum',                href: '/erratum',          group: 'page' as const, hint: 'Erreurs publiées' },
    { id: 'silence',         label: 'Le Silence éditorial',     href: '/silence',          group: 'page' as const, hint: 'UI bannie' },
    { id: 'cote-inversee',   label: 'La Cote inversée',         href: '/cote-inversee',    group: 'page' as const, hint: 'Cote de l’éditeur' },
    { id: 'method',          label: 'La Méthode',               href: '/method',           group: 'page' as const, hint: 'Formule de la Cote' },
    { id: 'etages',          label: 'Les Étages',               href: '/etages',           group: 'page' as const, hint: 'La maison plutôt que le tarif' },
    { id: 'survie',          label: 'Le Calculateur de survie', href: '/survie',           group: 'page' as const, hint: 'Pré-trade arithmétique' },
    { id: 'bureau-partage',  label: 'Le Bureau partagé',        href: '/bureau-partage',   group: 'page' as const, hint: 'En préparation' },
    { id: 'edition-lifetime',label: 'L’Édition Lifetime',       href: '/edition-lifetime', group: 'page' as const, hint: 'Livret postal' },
    { id: 'institutionnel',  label: 'L’Institutionnel',         href: '/institutionnel',   group: 'page' as const, hint: 'Desks et prop-firms' },
    { id: 'mecenat',         label: 'Le Mécénat',               href: '/mecenat',          group: 'page' as const, hint: 'Un mois pour un autre' },
  ],
  en: [
    ...
    { id: 'tools', label: 'Tools', href: '/tools', group: 'page' as const },
    ...
    { id: 'voix',            label: 'The Voices',               href: '/voix',             group: 'page' as const, hint: 'Monthly interviews' },
    { id: 'lexique',         label: 'The Living Lexicon',       href: '/lexique',          group: 'page' as const, hint: 'Click any term' },
    { id: 'cercle',          label: 'The Reading Circle',       href: '/cercle',           group: 'page' as const, hint: 'Reader pairing' },
    { id: 'almanach',        label: 'The Almanac',              href: '/almanach',         group: 'page' as const, hint: 'Criée archive' },
    { id: 'annuaire',        label: 'The Index',                href: '/annuaire',         group: 'page' as const, hint: 'Lesson index' },
    { id: 'recherche',       label: 'The Search',               href: '/recherche',        group: 'page' as const, hint: 'Empty box' },
    { id: 'refus',           label: 'The Refusal',              href: '/refus',            group: 'page' as const, hint: 'Manifesto by negation' },
    { id: 'erratum',         label: 'The Erratum',              href: '/erratum',          group: 'page' as const, hint: 'Editor mistakes' },
    { id: 'silence',         label: 'The Editorial Silence',    href: '/silence',          group: 'page' as const, hint: 'Banished UI' },
    { id: 'cote-inversee',   label: 'The Inverted Score',       href: '/cote-inversee',    group: 'page' as const, hint: 'Editor Score' },
    { id: 'method',          label: 'The Method',               href: '/method',           group: 'page' as const, hint: 'Score formula' },
    { id: 'etages',          label: 'The Floors',               href: '/etages',           group: 'page' as const, hint: 'House before the bill' },
    { id: 'survie',          label: 'The Survival Calculator',  href: '/survie',           group: 'page' as const, hint: 'Pre-trade math' },
    { id: 'bureau-partage',  label: 'The Shared Desk',          href: '/bureau-partage',   group: 'page' as const, hint: 'In preparation' },
    { id: 'edition-lifetime',label: 'The Lifetime Edition',     href: '/edition-lifetime', group: 'page' as const, hint: 'Mailed booklet' },
    { id: 'institutionnel',  label: 'The Institutional',        href: '/institutionnel',   group: 'page' as const, hint: 'Desks and prop firms' },
    { id: 'mecenat',         label: 'The Patronage',            href: '/mecenat',          group: 'page' as const, hint: 'One month for another' },
  ],
};
