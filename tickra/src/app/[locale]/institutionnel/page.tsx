...
const COPY = {
  ...
  en: {
    ...
    head3: 'One audit.',
    intro:
      'When nkNOWTrade enters a trading desk or a prop firm, it does not lose its editorial — it adapts it. The Registrar becomes collective: it reads the whole team’s ledger and returns weekly observations. The Wall of Silence applies to team drawdowns. The Score becomes a room note, signed by the editor.',
    bullets: [
