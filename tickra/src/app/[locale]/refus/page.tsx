...
// /[locale]/refus — Le Refus. Ten things nkNOWTrade will never build.
...
const COPY = {
  fr: {
    ...
    intro:
      'Un site de trading se définit autant par ce qu’il refuse que par ce qu’il publie. Voici les dix lignes que nkNOWTrade ne franchira pas. Si une seule d’entre elles vous manque, vous êtes au mauvais endroit — et nous préférons que vous le sachiez maintenant.',
    footer:
  ...
  en: {
    ...
    intro:
      'A trading site is defined as much by what it refuses as by what it publishes. Here are the ten lines nkNOWTrade will not cross. If even one of them is something you need, you are in the wrong place — and we would rather you know now.',
    footer:
    ...
    <>
      ...
      <EditorialJsonLd
        ...
        description={locale === 'fr'
          ? 'Dix choses que nkNOWTrade ne construira jamais. Un manifeste par la négation.'
          : 'Ten things nkNOWTrade will never build. A manifesto by negation.'}
        locale={locale}
      />
