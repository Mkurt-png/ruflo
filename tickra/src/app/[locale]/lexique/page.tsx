...
const COPY = {
  fr: {
    ...
    intro:
      'nkNOWTrade ne survole pas. Les termes soulignés en pointillés ne s’ouvrent qu’au clic, et seulement si le lecteur le demande. Voici comment ça se lit.',
  ...
  en: {
    ...
    head3: 'No tooltip.',
    intro:
      'nkNOWTrade does not hover. Dotted-underlined terms open only on click, and only when the reader asks. Here is how it reads.',
