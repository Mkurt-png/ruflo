...
const FOUNDER = {
  fr: {
    ...
    bio: [
      ...
      'nkNOWTrade, c’est le parcours que j’aurais voulu avoir à 18 ans. Pas un cours magistral — un atelier : 10 minutes par jour, des figures réelles, un risque mesuré, un journal qui te confronte.',
    ],
    proofs: [
  ...
  en: {
    ...
    bio: [
      ...
      'nkNOWTrade is the curriculum I wish I had at 18. Not a lecture — a workshop: 10 minutes a day, real charts, measured risk, a journal that confronts you.',
    ],
    proofs: [
