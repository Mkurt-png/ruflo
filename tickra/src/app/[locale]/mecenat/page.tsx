...
const COPY = {
  fr: {
    ...
    candor:
      'Note d’honnêteté : le don nécessite l’activation Stripe et la mécanique d’attribution serveur. nkNOWTrade prépare la sienne. Cette page reste pour que l’intention soit publique avant le bouton.',
    cta: 'Voir les étages',
  },
  en: {
    ...
    candor:
      'Honesty note: the gift requires Stripe activation and server-side allocation. nkNOWTrade is preparing both. This page stays so the intent is public before the button.',
    cta: 'See the floors',
  },
} as const;
