...
// one about the UI itself. Lists every gamified pattern nkNOWTrade
...
const BANISHED: Banished[] = [
  ...
  },
  {
    ...
    why: {
      fr: 'Cocher des cases pour « débloquer » nkNOWTrade suggère qu’il y a un piège. Il n’y en a pas — la maison est ouverte.',
      en: 'Checking boxes to "unlock" nkNOWTrade suggests there is a trick. There is none — the house is open.',
    },
    prose: {
...
const COPY = {
  fr: {
    ...
    head3: 'ne fera pas.',
    intro:
      'Le Refus dit ce que nkNOWTrade ne construira jamais. Le Silence éditorial dit comment nkNOWTrade ne vous parlera jamais. Les pastilles, les confettis, les pop-ups, les paliers : ils ont leur grammaire ailleurs. Ici, on écrit en lettres.',
    ...
    footer:
      'Si vous voyez une pastille rouge, un compteur ou un confetti quelque part sur nkNOWTrade, écrivez-nous. Ce sera consigné dans /erratum avant d’être retiré.',
    instead: 'À la place',
  },
  en: {
    ...
    head3: 'will not do.',
    intro:
      'The Refusal says what nkNOWTrade will never build. The Editorial Silence says how nkNOWTrade will never speak to you. Dots, confetti, popups, tiers: they have their grammar elsewhere. Here, we write in letters.',
    ...
    footer:
      'If you see a red dot, a counter, or confetti anywhere on nkNOWTrade, write to us. It will be logged in /erratum before being removed.',
    ...
    <>
      ...
      <EditorialJsonLd
        ...
        description={locale === 'fr'
          ? 'Les patterns d’UI que nkNOWTrade ne déploiera pas.'
          : 'UI patterns nkNOWTrade will not display.'}
        locale={locale}
      />
