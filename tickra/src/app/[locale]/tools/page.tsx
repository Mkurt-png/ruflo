...
const meta = {
  fr: {
    title: 'Outils',
    description:
      'Calculateurs et simulateurs de trading nkNOWTrade : taille de position, espérance, math des pertes, risque de ruine (Monte-Carlo), projection de croissance, horloge des sessions forex et reconnaissance de figures. Tout en local, rien n’est envoyé.',
  },
  en: {
    title: 'Tools',
    description:
      'nkNOWTrade trading calculators and simulators: position sizing, expectancy, the math of losses, Monte-Carlo risk of ruin, growth projection, a live forex sessions clock and candlestick-pattern training. All local, nothing is sent.',
  },
};
