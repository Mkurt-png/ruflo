...
const COPY = {
  fr: {
    ...
    intro:
      'L’Annuaire liste, par ordre alphabétique, chaque leçon publiée sur nkNOWTrade. Pas de filtres, pas de tags, pas de recommandations : une page sobre, faite pour être lue par sauts ou par balayage. C’est aussi la mémoire du site — si une notion n’apparaît pas ici, c’est qu’elle n’existe pas chez nous.',
  ...
  en: {
    ...
    head3: 'On one page.',
    intro:
      'L’Annuaire lists, in alphabetical order, every lesson published on nkNOWTrade. No filters, no tags, no recommendations: a calm page, made to be read by leaps or by scanning. It is also the site’s memory — if a notion does not appear here, it does not exist in our work.',
    counts: (n: number, tracks: number) =>
