...
// /[locale]/etages — L'Étage Pro. Re-narrates nkNOWTrade's three tiers
...
const COPY = {
  fr: {
    ...
    intro:
      'La plupart des sites de trading affichent trois colonnes côte à côte, à hauteur d’œil, avec des cases à cocher. nkNOWTrade préfère une maison : on entre par le rez-de-chaussée, on monte si on veut, on redescend quand on veut. Voici l’organisation, étage par étage.',
  ...
  en: {
    ...
    head3: 'One house.',
    intro:
      'Most trading sites display three columns side by side, at eye level, with checkboxes. nkNOWTrade prefers a house: you enter on the ground floor, you go up if you want, you come back down when you want. Here is the organization, floor by floor.',
