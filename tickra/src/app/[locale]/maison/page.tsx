...
// piece nkNOWTrade has built. The Navbar will stay slim; this page
    ...
    rooms: [
      {
        ...
        caption: {
          fr: 'Dix choses que nkNOWTrade ne construira jamais. Permanent.',
          en: 'Ten things nkNOWTrade will never build. Permanent.',
        },
      },
      {
        slug: 'erratum',
  ...
  },
  {
    ...
    rooms: [
      ...
      },
      {
        ...
        caption: {
          fr: 'nkNOWTrade pour les desks et prop-firms. Sur conversation.',
          en: 'nkNOWTrade for desks and prop firms. On conversation.',
        },
      },
      {
        slug: 'mecenat',
...
const COPY = {
  fr: {
    ...
    intro:
      'nkNOWTrade n’est pas un menu déroulant. C’est une maison. Voici le plan complet : les rituels au sud, les lectures au nord, les archives en sous-sol, les manifestes au mur du salon, les outils calmes près de la fenêtre. Vous entrez par où vous voulez.',
  ...
  en: {
    ...
    intro:
      'nkNOWTrade is not a dropdown menu. It is a house. Here is the full plan: the rituals to the south, the readings to the north, the archives in the basement, the manifestos on the parlor wall, the calm tools near the window. You enter wherever you like.',
    ...
    <>
      ...
      <EditorialJsonLd
        ...
        description={locale === 'fr'
          ? 'Plan de la maison nkNOWTrade : toutes les pièces éditoriales sur une page.'
          : 'Plan of the nkNOWTrade house: every editorial room on one page.'}
        locale={locale}
      />
