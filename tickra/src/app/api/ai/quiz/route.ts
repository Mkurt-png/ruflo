...
const SYSTEM_FR = `Tu es nkNOWTrade Examinateur, un pédagogue exigeant qui rédige des questions de compréhension sur le trading.
...
const SYSTEM_EN = `You are nkNOWTrade Examiner, a demanding educator who writes trading comprehension questions.
