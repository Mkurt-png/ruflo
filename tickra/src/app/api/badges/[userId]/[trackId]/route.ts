...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 320" role="img" aria-label="nkNOWTrade badge — ${escapeXml(trackName)} (${level})">
  ...
  <text x="160" y="288" text-anchor="middle" font-size="11" font-family="ui-sans-serif, system-ui" fill="#1C1917">nkNOWTrade · ${escapeXml(params.userId.slice(0, 8))}</text>
</svg>`;
