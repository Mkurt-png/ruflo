...
const seeded: Seed = {
    ...
    quiz: [
      {
        ...
        correct: 1,
        rationale: { fr: 'C’est une information, pas un signal. nkNOWTrade n’entraîne jamais d’entrée sur une seule bougie.', en: 'It is information, not a signal. nkNOWTrade never drills entries off a single candle.' },
      },
      {
      ...
      {
        q: { fr: 'Quel ratio corps/amplitude définit une marubozu chez nkNOWTrade ?', en: 'What body/range ratio defines a marubozu at nkNOWTrade?' },
  ...
  'candles-11': {
    intro: {
      fr: [
        ...
        'La règle de nkNOWTrade : avant de lire la bougie, repérez d’abord la tendance, les niveaux, et la volatilité. La bougie n’est que le déclic final.',
      ],
      en: [
        ...
        'nkNOWTrade’s rule: before reading the candle, locate the trend, the levels, and the volatility. The candle is just the final trigger.',
      ],
    },
    drill: {
      prompt: {
  ...
  'candles-12': {
    intro: {
      fr: [
        ...
        'nkNOWTrade n’utilise pas ces tests pour vous juger. Ils servent à fixer ce qui mérite révision avant de continuer.',
      ...
      en: [
        ...
        'nkNOWTrade does not use these tests to judge. They flag what deserves a review before continuing.',
  ...
  'structure-09': {
    intro: {
      fr: [
        ...
        'C’est l’un des pièges les plus chers pour les débutants. La règle de nkNOWTrade : attendre la clôture au‑delà ET, idéalement, le retest du niveau cassé.',
      ...
      en: [
        ...
        'One of the most expensive traps for beginners. nkNOWTrade’s rule: wait for the close beyond AND, ideally, the retest of the broken level.',
  ...
  'structure-11': {
    intro: {
      fr: [
        ...
        'La règle de nkNOWTrade : 3 niveaux maximum (support majeur, résistance majeure, ligne de tendance ou MA200), pas plus. Tout autre tracé doit s’effacer.',
      ...
      en: [
        ...
        'nkNOWTrade’s rule: 3 levels max (major support, major resistance, trendline or 200MA), no more. Any other markup must go.',
  ...
  'risk-05': {
    intro: {
      fr: [
        ...
        'Sous 1:2 (vous risquez 1 pour gagner 2), nkNOWTrade ne recommande pas le trade. La marge d’erreur est trop fine pour compenser les frais et les ratés.',
      ...
      en: [
        ...
        'Below 1:2 (risk 1 to gain 2), nkNOWTrade does not recommend the trade. Margin of error is too thin to absorb fees and misses.',
    ...
    quiz: [
      {
        q: { fr: 'En dessous de quel R:R nkNOWTrade refuse le trade ?', en: 'Below which R:R does nkNOWTrade refuse?' },
  ...
  'basics-14': {
    ...
    quiz: [
      ...
      },
      {
        ...
        correct: 0,
        rationale: { fr: 'nkNOWTrade empile les blocs.', en: 'nkNOWTrade stacks blocks.' },
      },
      {
  ...
  'brokers-05': {
    intro: {
      fr: [
        ...
        'nkNOWTrade intègre TradingView dans les leçons et le simulateur. Pas besoin de compte payant pour démarrer — le free suffit jusqu’à ce que vous ayez besoin de multi-écrans.',
      ],
      en: [
        ...
        'nkNOWTrade embeds TradingView inside lessons and the simulator. No paid plan needed to start — free is enough until you need multi-screens.',
      ],
    },
  ...
  'brokers-10': {
    intro: {
      fr: [
        ...
        'Bonus pratique : faites un dépôt-retrait test de 50 € sur votre futur broker avant de prendre l’abonnement Pro nkNOWTrade. C’est 50 € d’assurance pour vérifier que le canal fonctionne dans les deux sens.',
      ],
      en: [
        ...
        'Practical bonus: do a €50 test deposit-withdrawal on your future broker before subscribing to nkNOWTrade Pro. It’s €50 of insurance to check the channel works both ways.',
      ],
    },
    ...
    quiz: [
      ...
      { q: { fr: 'La séquence apprentissage est :', en: 'The learning sequence is:' }, options: { fr: ['Brokers → Bougies → Risque', 'Risque en premier toujours', 'Au hasard'], en: ['Brokers → Candles → Risk', 'Risk first always', 'Random'] }, correct: 0, rationale: { fr: 'nkNOWTrade empile.', en: 'nkNOWTrade stacks.' } },
  ...
  // La piste la plus alignée avec la voix éditoriale nkNOWTrade : peu de
  ...
  'psy-10': {
    ...
    quiz: [
      { q: { fr: 'Trois entrées par trade :', en: 'Three lines per trade:' }, options: { fr: ['Décision, émotion, phrase de retour', 'Heure, P&L, ticker', 'Aucune'], en: ['Decision, emotion, return-sentence', 'Time, P&L, ticker', 'None'] }, correct: 0, rationale: { fr: 'Format nkNOWTrade.', en: 'nkNOWTrade format.' } },
...
const PLACEHOLDER_QUIZ_POOL: ReadonlyArray<{
  ...
  {
    q: { fr: 'La méthode nkNOWTrade met l’accent sur :', en: 'The nkNOWTrade method emphasises:' },
...
function placeholder(track: TrackMeta, lesson: LessonMeta): LessonContent {
  ...
  return {
    ...
    drill: {
      ...
      correct: 0,
      rationale: {
        fr: 'La méthode nkNOWTrade : exposé → exercice → revue. Sauter une étape ne fait pas gagner du temps.',
        en: 'The nkNOWTrade method: brief → drill → review. Skipping a step does not save time.',
      },
    },
    quiz,
  };
